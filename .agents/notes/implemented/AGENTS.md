...
These Agent Notes describe shipped decisions. Follow the [root instructions](../../../.template/AGENTS.md), [documentation standard](../../../.template/docs/AGENTS.md), and [Agent Note format](../README.md#the-file-format); `verify-agent-note-format` gates the lifecycle-specific structure.
