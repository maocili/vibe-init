---
name: code-review
description: Use when reviewing a pull request or change in a project initialized by dsh-rules; verify live scope, contracts, lifecycle and security behavior, required evidence, and actionable findings.
---
