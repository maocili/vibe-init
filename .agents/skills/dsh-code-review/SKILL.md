...
- [AGENTS.md](../../../.template/AGENTS.md) and packages/AGENTS.md: standing repository and package authoring rules.
- docs/defensive-patterns.md: subprocess, callback, async-state, and disposal bug classes.
- [docs/AGENTS.md](../../../.template/docs/AGENTS.md): documentation placement and prose discipline.
...
- docs/testing.md and the quality-gates Agent Note: required test tiers and gates.
...
- For bilingual changes, read [translation-rules.md](../../../.template/docs/i18n/translation-rules.md) and [terminology.md](../../../.template/docs/i18n/terminology.md); the extended translation skill is outside automatic review and runs only on explicit user invocation.
