...
verification commands before translating. In a vibe-init project these may be under
`.vibe-init/toolchain/docs/i18n/`; use the paths and commands that actually exist. Both language files
...
level. In a vibe-init project, use the enabled commands under `.vibe-init/toolchain/package.json` rather
