...
| M3 可分发 | `package.json` 的 `@maocili/dsh-vibe` + `dsh.bundle.patch`、根 `cordis.patch.yml`；`test/package.test.mjs` 验证 npm tarball 清单、临时安装、Cordis 入口和 CLI init/status | 达成（2026-09-04） |
