// Project-local ownership state for dsh-rules upgrade migrations.
...
export const STATE_RELATIVE_PATH = '.dsh-rules/state.json'
...
function safeManagedFileRecord(record) {
  ...
  const allowed = record.kind === 'generated-doc' && path === 'docs/AGENTS.md'
    || record.kind === 'toolchain' && path.startsWith('.dsh-rules/toolchain/')
