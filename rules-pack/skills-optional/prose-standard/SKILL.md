---
name: prose-standard
description: Use when writing, reviewing, restoring, trimming, or auditing prose, comments, documentation, prompts, diagnostics, or visible strings in a project initialized by dsh-rules; preserve required contracts while removing reasoning leakage and repetition.
---
