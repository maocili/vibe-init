 ...
 * consuming workflow is `.agents/skills/translate-docs/SKILL.md`.
 */
...
// dsh-rules distilled: corpus/manifest live beside the gates (toolchain home); the brief targets project docs.
